...
import com.supermario.game.sprites.InteractiveTileObject;
...
public class WorldContactListener implements ContactListener {
    ...
    public void beginContact(Contact contact) {
        ...
        int cDef = fixA.getFilterData().categoryBits | fixB.getFilterData().categoryBits; //TODO: what does this syntax mean?
        switch (cDef){
            ...
            case MarioBros.ITEM_BIT | MarioBros.MARIO_BIT:
                ...
                break;
            case MarioBros.BOTTOM_BIT | MarioBros.MARIO_BIT:
                if(fixA.getFilterData().categoryBits == MarioBros. MARIO_BIT){
